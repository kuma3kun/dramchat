...
Opal.modules["opal/platform"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, phantomjs = nil, browser = nil, node = nil, nashorn = nil;
  ...
  return (function() {if (nashorn !== false && nashorn !== nil && nashorn != null) {Opal.cdecl($scope, 'OPAL_PLATFORM', "nashorn");
  return self.$require("nashorn");}else if (phantomjs !== false && phantomjs !== nil && phantomjs != null) {Opal.cdecl($scope, 'OPAL_PLATFORM', "phantomjs");
  return self.$require("phantomjs");}else if (node !== false && node !== nil && node != null) {Opal.cdecl($scope, 'OPAL_PLATFORM', "nodejs");
  self.$require("nodejs/kernel");
  return self.$require("nodejs/io");}else { return nil }})();
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require']);
  self.$require("opal");
  return self.$require("opal/platform");
})(Opal);
}).call(Wrapper);
